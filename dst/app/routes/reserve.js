...
const reserveRouter = express_1.Router();
reserveRouter.get('/theater/:theaterCode/count_free_seat/', (req, res) => {
    fs.readFile(`${__dirname}/../../../data/countFreeSeat.json`, (__2, buffer) => {
        ...
        for (let i = 0; i < days; i++) {
            ...
            dates.push(Object.assign({}, data.list_date[0], { date_jouei: dateJouei.tz('Asia/Tokyo').format('YYYYMMDD') }));
        }
...
reserveRouter.get('/theater/:theaterCode/del_tmp_reserve/', (__, res) => {
    res.json({
        status: 0,
        message: ''
    });
